...
sys.path.append('..')
from pke_zh.supervised.kea import Kea
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='kea_test.pkl', help='model file path to save')
